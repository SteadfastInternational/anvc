                ...
                <div className="container">
                    <div className="banner-heading rounded-2xl overflow-hidden relative max-lg:h-[300px] max-md:h-[260px]">
                        ...
                        <div className="text-content absolute top-1/2 -translate-y-1/2 right-10">
                            ...
                            <Link href={'/shop/breadcrumb-img'} className='button-main lg:mt-10 mt-6'>Explore More</Link>
                        </div>
                    </div>
                                ...
                                <div className="right sm:w-1/2">
                                    <div className="heading flex items-center justify-between flex-wrap gap-y-4">
                                        <div className="left">
                                            ...
                                            <div className="heading3 sm:mt-3 mt-1">Linen Wrap pop-surface-lightes</div>
                                        </div>
                                        <div className="right">
                                            <Link href={'/shop/breadcrumb-img'} className='button-main bg-white text-black border border-black'>View All Products</Link>
                                        </div>
                                    </div>
                                    <div className="list-product hide-product-sold grid grid-cols-2 md:gap-[30px] gap-5 md:mt-10 mt-6">
                                        {data
                                            .filter(product => product.type === 'switch-socket' && product.category === 'fashion')
                                            .slice(0, 2)
                                            .map(product => (
