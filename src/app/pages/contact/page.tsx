                    ...
                    <div className="flex justify-between max-lg:flex-col gap-y-10">
                        ...
                        <div className="right lg:w-1/4 lg:pl-4">
                            <div className="item">
                                ...
                                <p className="mt-3">5 Afisman Dr, Ikeja, Lagos 100282, Lagos</p>
                                <p className="mt-3">Phone: <span className='whitespace-nowrap'>+234-907-651-5161</span></p>
                                <p className="mt-1">Email: <span className='whitespace-nowrap'>steadfastinteranationaltrade@gmail.com</span></p>
                            </div>
                            <div className="item mt-10">
                                <div className="heading4">Open Hours</div>
                                <p className="mt-3">Mon - Fri: <span className='whitespace-nowrap'>7:30am - 8:00pm WAT</span></p>
                                <p className="mt-3">Saturday: <span className='whitespace-nowrap'>8:00am - 6:00pm WAT</span></p>
                                <p className="mt-3">Sunday: <span className='whitespace-nowrap'>9:00am - 5:00pm WAT</span></p>
                            </div>
                        </div>
                    </div>
                </div>
