...
const Wishlist = () => {
    ...
    // Create a copy of the filtered data for sorting
    let sortedData = [...filteredData];

    if (sortOption === 'soldQuantityHighToLow') {
        filteredData = sortedData.sort((a, b) => b.quantity - a.quantity); // Assuming quantity represents sold quantity
    }
                            ...
                            <div className="right flex items-center gap-3">
                                <div className="select-block filter-type relative">
                                    ...
                                    >
                                        ...
                                        {['chandelier', 'pop-surface-light', 'outdoor-light', 'solar-light', 'indoor-light', 'underwear', 'pendant-light', 'switch-socket,electrical-accessories'].map((item, index) => (
                                            <option
                                                key={index}
